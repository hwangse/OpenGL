...
glm::mat4 ModelViewProjectionMatrix, ModelViewMatrix,ModelViewMatrix2;
...
void display(void) {
	...
	draw_floor();
 	...
 	set_material_tiger();
 	ModelViewMatrix2 = glm::rotate(ViewMatrix, -rotation_angle_tiger, glm::vec3(0.0f, 1.0f, 0.0f));
	ModelViewMatrix2 = glm::translate(ModelViewMatrix2, glm::vec3(200.0f, 0.0f, 0.0f));
	ModelViewMatrix2 = glm::rotate(ModelViewMatrix2, -90.0f*TO_RADIAN, glm::vec3(1.0f, 0.0f, 0.0f));
	ModelViewProjectionMatrix = ProjectionMatrix * ModelViewMatrix2;
	ModelViewMatrixInvTrans = glm::inverseTranspose(glm::mat3(ModelViewMatrix2));
...
void set_up_scene_lights(void) {
	...
	light[2].light_on = 1;
	light[2].position[0] = 0.0f; light[2].position[1] = 200.0f; 	// point light position in MC
	...
	glm::vec4 position_EC2 = ModelViewMatrix2 * glm::vec4(light[2].position[0], light[2].position[1],
...
void main(int argc, char *argv[]) {
	// Phong Shading
	char program_name[64] = "Sogang CSE4170 5.3.5.Tiger_Shading_PS_GLSL";
